...
def lambda_handler(event, context):
    ...
    try:
        ...
        body = json.dumps({
                        "prompt": f"\n\nHuman: create a minimum 3 paragraph summary of the following and also provide top 5 recommendations based on it. Label the summary with \"Summary\" and recommendations with \"Top 5 recommendations\":\n{file_data} \n\nAssistant:",
